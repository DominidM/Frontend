...
export const SeccionesProductosYMarcas: React.FC = () => {
  ...
  return (
    <div className="bg-gray-50 py-16">
      <div className="container mx-auto text-center">
        ...
        {/* Línea debajo de la sección de carruseles */}
        <div className="h-0.5 w-48 mx-auto mt-12 mb-12" style={{ backgroundColor: blueLineColor }}></div>

        {/* Sección Trabajamos con las mejores marcas */}
        <h2 className="text-xl md:text-2xl font-semibold text-gray-800 mb-6">Trabajamos con las mejores marcas</h2>
        <div className="flex flex-wrap justify-center gap-12">
          {marcas.map((marca, index) => (
            <div key={index} className="h-20 w-48 flex items-center justify-center">
              <img src={marca.logoSrc} alt={marca.nombre} className="object-contain h-full w-full" />
            </div>
          ))}
        </div>
      </div>
