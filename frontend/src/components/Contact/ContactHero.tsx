            ...
            <div className="flex flex-col gap-8">
                ...
                <div className="relative w-full max-h-96 overflow-hidden">
                    ...
                    <div className="absolute inset-0 flex flex-col items-center justify-center rounded-md z-10">
                        ...
                        {/* Título */}
                        <h2 className="text-2xl sm:text-4xl md:text-5xl font-bold text-black text-center z-20">
                            ¿Quiénes Somos?
                        </h2>
                ...
                <div id="scroll-target" className="relative w-full max-h-96 overflow-hidden">
                    <img
                        ...
                        className="w-full h-full object-cover rounded-md"
                    />
                    <div className="absolute inset-0 bg-black bg-opacity-40 rounded-md flex items-center justify-center p-4 sm:p-8">
